...
public class ELBallController : MonoBehaviour
{
    ...
    {
        if (!hasBeenLaunched && !elgamemanager.isDragging)
        {
            LaunchBall();
        }
    ...
    void LaunchBall()
    {
        Vector2 launchForce = ELGameManager.shotDirection * (ELGameManager.shotDistance * 1.45f);
